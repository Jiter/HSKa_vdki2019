...
def loadProbabilityArrays(w, h, b, g, r,):
    ...
    prob.append(np.array([
            ...
            [12,    0,      0,      0,      0],      # 108 - 109
            [13,    0,      0,      0,      0],      # 110 - 111
            [14,    0,      0.25,      0,      0],      # 118 - 119
            [15,    0,      0.091,      0,      0],      # 120 - 121
            [16,    0,      0.272,      0,      0],      # 122 - 123
            [17,    0.143,  0.227,      0,      0],      # 124 - 125
            ...
            [24,    0.143,  0,      0,      0.145],      # 138 - 139
            [25,    0,      0,      0,      0.091],  # 140 - 141
            [26,    0,      0,      0,      0.145],      # 142 - 143
            [27,    0,      0,      0,      0.072],      # 144 - 145
            [28,    0,      0,      0,      0.109],      # 146 - 147
            [29,    0,      0,      0,      0.127],      # 148 - 149
            [30,    0,      0,      0,      0.054],      # 150 - 151
            [31,    0.143,  0,      0,      0],      # 152 - 153
            [32,    0,      0,      0,      0],  # 154 - 155
            [33,    0,      0,      0,      0],      # 156 - 157
            ]))
