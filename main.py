...
def loadProbabilityArrays(w, h, b, g, r,):
    ...
    prob.append(np.array([
            ...
            [4,     0,      0,      0,      0],      # 100 - 104
            [5,     0,      0,      0,      0],      # 105 - 109
            [6,     0.065,  0,      0,      0.273],  # 110 - 114
            [7,     0.078,   0,      0,     0.156],  # 115 - 119
            [8,     0.117,  0.182,  0,      0.026],  # 120 - 124
            [9,     0.026,  0.818,  0,      0.182],  # 125 - 129
            [10,    0,      0,      0,      0.234],  # 130 - 134
            [11,    0,      0,      0,      0.130],  # 135 - 139
            [12,    0,      0,      0,      0],      # 140 - 144
            [13,    0,      0,      0.333,  0],      # 145 - 149
            [14,    0,      0,      0.257,  0],      # 150 - 154
            [15,    0,      0,      0.318,  0],      # 155 - 159
            [16,    0,      0,      0.091,  0],      # 160 - 164
            [17,    0.143,  0,      0,      0],      # 165 - 169
            ]))
